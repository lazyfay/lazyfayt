## lzfcore.py - useful module of Lazyfay
##
import os, sys, time
...
configBase = "[HOME] = ~"
configFile = "../lazyfay.conf"
cache_1 = prefix+"/tmp/lazyfay_1"
