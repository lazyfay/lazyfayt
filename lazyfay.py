## lazymfay.py - Lazymfay v1.0
##
import os, sys
import readline
from time import sleep as timeout
from core.lzfcore import *
...
def main():
	...
	print("\n   [00] Exit the Lazyfay\n")
	lazyfay = input("lzfy > set_install ")

	# 01 - Information Gathering
	if lazyfay.strip() == "1" or lazyfay.strip() == "01":
		...
		infogathering = input("lzfy > set_install ")
		if infogathering == "@":
			infogathering = ""
			for x in range(1,38):
				infogathering += f"{x} "
	...
	# 02 - Vulnerability Analysis
	elif lazyfay.strip() == "2" or lazyfay.strip() == "02":
		print("\n    [01] Nmap: Utility for network discovery and security auditing")
		...
		print("\n    [00] Back to main menu\n")
		vulnsys = input("lzfy > set_install ")
		if vulnsys == "@":
			vulnsys = ""
			for x in range(1,24):
				vulnsys += f"{x} "
	...
	# 03 - Web Hacking
	elif lazyfay.strip() == "3" or lazyfay.strip() == "03":
	...
	elif lazyfay.strip() == "4" or lazyfay.strip() == "04":
	...
	# 05 - Password Attacks
	elif lazyfay.strip() == "5" or lazyfayx.strip() == "05":
		...
		print("\n    [00] Back to main menu\n")
		passtak = input("lzfy > set_install ")
		if passtak == "@":
			passtak = ""
			for x in range(1,22):
				passtak += f"{x} "
	...
	# 06 - Wireless Attacks
	elif lazyfay.strip() == "6" or lazyfay.strip() == "06":
		...
		print("\n    [00] Back to main menu\n")
		wiretak = input("lzfy > set_install ")
		if wiretak == "@":
			wiretak = ""
			for x in range(1,5):
				wiretak += f"{x} "
	...
	# 07 - Reverse Engineering
	elif lazyfay.strip() == "7" or lazyfay.strip() == "07":
		...
		print("\n    [00] Back to main menu\n")
		reversi = input("lzfy > set_install ")
		if reversi == "@":
			reversi = ""
			for x in range(1,6):
				reversi += f"{x} "
	...
	# 08 - Exploitation Tools
	elif lazyfay.strip() == "8" or lazyfay.strip() == "08":
		...
		print("\n    [00] Back to main menu\n")
		exploitool = input("lzfy > set_install ")
		if exploitool == "@":
			exploitool = ""
			for x in range(1,9):
				exploitool += f"{x} "
	...
	elif lazyfay.strip() == "9" or lazyfay.strip() == "09":
	...
	# 10 - Reporting Tools
		...
		print("\n    [00] Back to main menu\n")
		reportls = input("lzfy > set_install ")
		if reportls == "@":
			reportls = ""
			for x in range(1,6):
				reportls += f"{x} "
	...
	# 11 - Forensic Tools
		...
		print("\n    [00] Back to main menu\n")
		forensc = input("lzfy > set_install ")
		if forensc == "@":
			forensc = ""
			for x in range(1,4):
				forensc += f"{x} "
	...
	# 12 - Stress Testing
		...
		print("\n    [00] Back to main menu\n")
		stresstest = input("lzfy > set_install ")
		if stresstest == "@":
			stresstest = ""
			for x in range(1,9):
				stresstest += f"{x} "
	...
	# 13 - Install Linux Distro
		...
		print("    [05] Arch Linux")
		print("\n    [00] Back to main menu\n")
		innudis = input("lzfy > set_install ")
		if innudis == "@":
			innudis = ""
			for x in range(1,6):
				innudis += f"{x} "
	...
	# 14 - Termux Utility
		...
		print("\n    [00] Back to main menu\n")
		moretool = input("lzfy > set_install ")
		if moretool == "@":
			moretool = ""
			for x in range(1,24):
				moretool += f"{x} "
